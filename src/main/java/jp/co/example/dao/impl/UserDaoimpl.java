...
public class UserDaoimpl implements UserDao {
	...
	private final String SELECT_NAME = "SELECT * FROM products WHERE name = :userName";
	private final String SELECT_PRICE = "SELECT * FROM products WHERE price = :userPrice";

	private final String SELECT_NAME_PRICE = "SELECT * FROM products WHERE name =:userName AND price = :userPrice";
	...
	public List<User> findNameAndPrice(UserForm form) {
		...
		param.addValue("userPrice", form.getUserPrice());
		
		return jdbcTemplate.query(sql, param, new BeanPropertyRowMapper<User>(User.class));
	}
